        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-slate-300">
              Jaipur-based performance team for founders & creators. We build
              digital experiences that generate predictable business growth.
            </p>
            {/* Social Media Links */}
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white group-hover:text-[#00a651]">
                    {BUSINESS_CONFIG.whatsappFormatted}
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white group-hover:text-[#00a651] transition-colors">
                    {BUSINESS_CONFIG.address}
                  </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-center gap-3 text-center sm:flex-row sm:gap-4">
            ...
            <p className="text-xs font-medium text-slate-400">
              © {new Date().getFullYear()} {BUSINESS_CONFIG.name}. All Rights
              Reserved.
            </p>
            ...
            <p className="text-xs font-medium text-slate-500">
              ...
              <a
                href="https://grmindstech.com"
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-slate-300 transition-colors hover:text-[#00a651]"
              >
                GR Minds Tech
              </a>
            </p>
