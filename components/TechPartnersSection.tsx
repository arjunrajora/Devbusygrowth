            ...
            {TOOLS.map((tool) => (
              ...
              >
                <div className="relative rounded-[22px] border border-white/10 bg-[#071a3d] shadow-xl overflow-hidden min-h-[320px] sm:min-h-[360px] flex flex-col justify-end p-6 group-hover:border-[#00a651]/40 group-hover:shadow-[0_15px_35px_rgba(0,166,81,0.18)] transition-all duration-500">
                  ...
                  <span className="absolute top-4 left-4 z-10 px-2.5 py-1 rounded-full bg-[#050c1a]/85 border border-[#00a651]/40 text-[10px] font-bold uppercase tracking-wider text-[#00a651] pointer-events-none backdrop-blur-md">
                    {tool.category}
                  </span>

                  {/* Text Content */}
                  <div className="relative z-10 space-y-2 text-left bg-[#050c1a]/85 backdrop-blur-md p-4 rounded-xl border border-white/10">
                    <span className="text-xs font-semibold text-slate-300 tracking-wide">{tool.logo}</span>
