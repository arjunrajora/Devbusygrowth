...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#050c1a] text-slate-800 dark:text-slate-100 flex flex-col">
      {/* Top Header Navbar: Logo on Left, Only Logout Button on Right */}
      <header className="sticky top-0 z-40 border-b border-slate-200/80 dark:border-slate-800/80 bg-white/90 dark:bg-[#071a3d]/90 backdrop-blur-xl">
      ...
      {/* Main Admin Body */}
      <div className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8 flex gap-8">
        {/* Desktop Sidebar */}
        <aside className="hidden md:block w-64 shrink-0">
          <div className="sticky top-24 rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-[#071a3d]/80 p-4 shadow-xl backdrop-blur-xl space-y-1">
